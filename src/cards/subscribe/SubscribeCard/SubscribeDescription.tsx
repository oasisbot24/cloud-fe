  ...
  return (
    <Stack className="mx-4 my-8 gap-4 bg-neutral-200 p-8">
      ...
      <Typography variant="200R">
        ...
        3-1. 구독 기간 도중에 낮은 플랜으로 변경 할 시 높은 플랜은 갱신일 1일 전까지 유지가 됩니다.
      ...
      <Typography variant="200R">
        6. 자동결제는 이용 중단하지 않는 한 구독 기간이 자동으로 갱신되며, 구독 만료시 자동 갱신
        해제 되어 이용권이 종료됩니다.
      </Typography>
      <Typography variant="200R">
        7. 구독 중 이용 권한에 문제가 있을 경우, 결제 후 3일 이내에 고객센터를 통해 이용신청의
        철회가 가능합니다.
      </Typography>
      <Typography variant="200R">
