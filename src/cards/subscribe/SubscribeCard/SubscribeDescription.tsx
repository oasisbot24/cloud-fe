...
export default function SubscribeDescription() {
  return (
    <Stack className="mx-4 my-8 gap-4 bg-neutral-200 p-8">
      <Typography variant="300B">오아시스 구독 유의 사항</Typography>
      <Typography variant="200R">1. 만 14세 이상 회원만 구매 가능합니다.</Typography>
      <Typography variant="200R">
        2. 정기 결제 이용 도중 결제정보가 변경되거나 한도 부족등으로 결제가 실패된 경우 총 3회에
        걸쳐 재결제가 진행됩니다. (당일 09시, 15시, 18시)
        <br />
        2-1. 3회 이상에도 재결제가 안 이루어질 시, 익일 00시 이후 봇(자동거래)이 정지가 됩니다.
      </Typography>
      <Typography variant="200R">
        3. 결제 당일에는 중복 결제나 오류 방지를 위해 결제 정보 변경이 불가하므로, 다음 날 새롭게
        변경/결제 해야합니다.
      </Typography>
      <Typography variant="200R">
        4. 자동결제는 이용 중단하지 않는 한 구독 기간이 자동으로 갱신되며, 구독 만료시 자동 갱신
        해제 되어 이용권이 종료됩니다.
      </Typography>
      <Typography variant="200R">
        5. 구독 중 이용 권한에 문제가 있을 경우, 결제 후 3일 이내에 고객센터를 통해 이용신청의
        철회가 가능합니다.
      </Typography>
      <Typography variant="200R">
        6. 자동 결제로 인한 미이행 거래가 발생 할 경우 환불이 불가합니다. 서비스 이용 유의사항
      </Typography>
      ...
      <Typography variant="200R">- 구매한 서비스가 제공되지 않은 경우</Typography>
      <Typography variant="200R">
      ...
      <Typography variant="200R">
        3. 회사는 환불시 이용대금의 결제수단과 동일한 방법으로 환불하는 것을 원칙으로 합니다. 다만,
        동일한 결제수단으로 환불이 불가능한 경우 회사가 개별서비스에서 정하는 별도의 방법 으로
        환불합니다.
      </Typography>
      <Typography variant="200R">
        4. 회사는 환불 의무가 발생한 날로부터 3영업일 내에 환불절차를 진행합니다. 다만, 환불을
        위하여 이용자의 협조가 필요한 경우 이용자의 귀책사유로 환불이 지연된 경우 회사는 지연이자를
        부담하지 않습니다.
      </Typography>
      <Typography variant="200R">
