  ...
  return (
    <>
      <Stack direction="row" className="items-center gap-1 px-3 py-1">
        <Typography className="text-sm font-bold text-neutral-700">{item.presetName}</Typography>
        <IconButton sx={{ width: "24px", height: "24px" }}>
          <Image src="/icons/basic/setting.png" alt="세팅" width={24} height={24} />
        </IconButton>
        <Typography className="text-sm font-bold text-neutral-700">/</Typography>
        <Typography className="text-sm font-bold text-neutral-700">{item.coinName}</Typography>
        <CoinIcon coin={item.coinName} size={16} />
      </Stack>
      <Stack direction="row" className="items-center justify-between gap-4 p-3 py-2">
        ...
        <Stack direction="row" className="items-center gap-4">
          ...
          <Typography className="text-xs font-medium">{item.sellInfo.date}</Typography>
        </Stack>
      </Stack>
      <Stack direction="row" className="items-center justify-between gap-4 p-3 py-2">
        <Stack direction="row" className="items-center gap-4">
          <Chip label="구매" className="bg-sub-2 text-white" />
        ...
        <Stack direction="row" className="items-center gap-4">
          ...
          <Typography className="text-xs font-medium">{item.buyInfo.date}</Typography>
        </Stack>
      </Stack>
